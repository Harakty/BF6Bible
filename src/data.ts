...
export const copy = {
  ...
  openBuild: { it: 'Apri build', en: 'Open build' },
  openAlgorithmicBuild: { it: 'Apri build', en: 'Open build' },
  algorithmicBuild: { it: 'Build', en: 'Build' },
  curatedBuild: { it: 'Build', en: 'Build' },
  algorithmicStatus: { it: 'Build', en: 'Build' },
