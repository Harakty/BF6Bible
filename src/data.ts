...
export const sources: Source[] = [
  ...
  {
    id: 'ea-current-patch',
    label: 'EA Battlefield 6 Game Update 1.3.1.5',
    url: 'https://www.ea.com/it/games/battlefield/battlefield-6/news/battlefield-6-game-update-1-3-1-5',
    kind: 'official',
    weight: 1,
    note: {
      it: 'Patch ufficiale attiva dal 26 maggio 2026 alle 10:00 CEST, usata per la pagina Patch e impatto meta.',
      en: 'Official patch active from May 26, 2026 at 10:00 CEST, used for the Patch and meta-impact page.',
    },
  },
  {
    id: 'ea-classes',
...
export const copy = {
  ...
  patchPage: { it: 'Patch attiva', en: 'Active patch' },
  officialPatchNotes: { it: 'Note ufficiali EA', en: 'Official EA notes' },
  officialSource: { it: 'Fonte ufficiale', en: 'Official source' },
  patchVersion: { it: 'Versione patch', en: 'Patch version' },
  patchActiveSince: { it: 'Attiva da', en: 'Active since' },
  patchMetaImpact: { it: 'Impatto meta', en: 'Meta impact' },
  patchChanges: { it: 'Cambiamenti rilevanti', en: 'Relevant changes' },
  weaponMeta: { it: 'Weapon meta', en: 'Weapon meta' },
  redsecFlow: { it: 'Flow REDSEC', en: 'REDSEC flow' },
  weaponMetaChanged: { it: 'Balance armi modificato', en: 'Weapon balance changed' },
  weaponMetaUnchanged: { it: 'Nessun cambio danni/recoil/TTK', en: 'No damage/recoil/TTK change' },
  lastMetaPatch: { it: 'Ultima patch meta rilevante', en: 'Last meta-relevant patch' },
