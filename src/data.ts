...
export const sources: Source[] = [
  ...
  {
    id: 'battlefieldmeta',
    label: 'BattlefieldMeta Builds / Comparator',
    url: 'https://battlefieldmeta.gg/weapon-comparator',
    kind: 'comparator',
    weight: 0.65,
    note: {
      it: 'Build e comparator pubblici aggiornati a inizio maggio 2026; utili ma da validare contro i dati numerici.',
      en: 'Public builds and comparator updated in early May 2026; useful but should be validated against numeric data.',
    },
  },
  {
    id: 'ea-redsec-br101',
...
const kits = {
  ...
  kv9Secondary: secondaryKit(weaponCatalog.kv9, [
    term('Build KV9 da validare in gioco', 'KV9 build pending in-game validation', { verified: false }),
  ]),
...
export const copy = {
  ...
  bestBuild: { it: 'Build migliore', en: 'Best build' },
  openBuild: { it: 'Apri build', en: 'Open build' },
  externalBuild: { it: 'Fonte build', en: 'Source build' },
