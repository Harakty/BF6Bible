      ...
      },
      {
        ...
        loadouts: [
          ...
          loadout(
            ...
            'Scout + SMG',
            'Scout + SMG',
            'MINI SCOUT + SCW-10: sniper mobile solo se hai una SMG reale per sopravvivere al push.',
            'MINI SCOUT + SCW-10: mobile sniper only if you carry a real SMG to survive the push.',
            kits.miniScoutRange,
            kits.scwSecondary,
            term('Spec Ops / Forze speciali', 'Spec Ops'),
            skills.specOps,
            ...
            [
              ...
              {
                it: 'La SCW-10 è obbligatoria: MINI SCOUT serve per aprire/convertire, non per vincere push close.',
                en: 'The SCW-10 is mandatory: MINI SCOUT opens and converts fights, it does not win close pushes alone.',
              },
              {
...
export const copy = {
  ...
  buildProvenance: {
    it: 'Build calcolata dal nostro solver',
    en: 'Build calculated by our solver',
  },
  buildProvenanceTooltip: {
    it: 'Generata combinando archetype + scarcity + cost pressure sui dati baseline pubblici.',
    en: 'Generated combining archetype + scarcity + cost pressure on public baseline data.',
  },
  costPoints: { it: 'Costo', en: 'Cost' },
  costPointsValue: { it: '{points}/100 punti', en: '{points}/100 points' },
  costPointsTooltip: {
    it: 'Punti spesi del budget attachment. Il solver bilancia spesa vs utility.',
    en: 'Attachment budget points spent. The solver balances spend vs utility.',
  },
  ...
  placeholderRationale: {
    it: 'Razionale generico, in revisione',
    en: 'Generic rationale, under review',
  },
  baselineSourcesTitle: { it: 'Fonti dei dati baseline', en: 'Baseline data sources' },
  baselineSourcesNote: {
    it: 'I dati di partenza (stats armi e costi attachment) vengono da queste fonti pubbliche. Le build mostrate sono calcolate dal nostro solver, non scaricate da terzi.',
    en: 'Baseline data (weapon stats, attachment costs) comes from these public sources. The builds shown are calculated by our solver, not downloaded from third parties.',
  },
