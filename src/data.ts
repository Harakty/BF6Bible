...
export const copy = {
  ...
  dataStatus: { it: 'Dati armi aggiornati', en: 'Updated weapon data' },
  ...
  openBuild: { it: 'Apri build nostra', en: 'Open our build' },
  openAlgorithmicBuild: { it: 'Apri build algoritmica', en: 'Open algorithmic build' },
  algorithmicBuild: { it: 'Build algoritmica', en: 'Algorithmic build' },
  curatedBuild: { it: 'Build nostra', en: 'Our build' },
  algorithmicStatus: { it: 'Generata da algoritmo', en: 'Generated by algorithm' },
  buildScore: { it: 'Build score', en: 'Build score' },
  openedFrom: { it: 'Aperta da', en: 'Opened from' },
