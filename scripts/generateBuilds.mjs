...
const OUTPUT_PATH = resolve('src/generated/templateBuilds.ts')
...
async function main() {
  ...
  const file = `// Generated by scripts/generateBuilds.mjs. Do not edit by hand.\nexport const generatedTemplateBuilds = ${stableStringify(dataset)} as const\n`

  await mkdir(dirname(OUTPUT_PATH), { recursive: true })
  await writeFile(OUTPUT_PATH, file, 'utf8')
  console.log(`Generated ${builds.length} template builds.`)
}
